...
class ViewController: UIViewController {
    ...
    @IBAction func colorSelected(_ sender: UISegmentedControl) {
        ...
        if (firstSelection == 0 && secondSelection == 0) || (secondSelection == 0 && firstSelection == 0) {
            paintBucket.backgroundColor = mixColors(first: "Red", second: "Red")
        } else if (firstSelection == 0 && secondSelection == 1) || (secondSelection == 1 && firstSelection == 0) {
            paintBucket.backgroundColor = mixColors(first: "Red", second: "Yellow")
        } else if (firstSelection == 0 && secondSelection == 2) || (secondSelection == 2 && firstSelection == 0) {
            paintBucket.backgroundColor = mixColors(first: "Red", second: "Blue")
        } else if (firstSelection == 1 && secondSelection == 1) || (secondSelection == 1 && firstSelection == 1) {
            paintBucket.backgroundColor = mixColors(first: "Yellow", second: "Yellow")
        } else if (firstSelection == 2 && secondSelection == 2) || (secondSelection == 2 && secondSelection == 2) {
            paintBucket.backgroundColor = mixColors(first: "Blue", second: "Blue")
        } else if (firstSelection == 1 && secondSelection == 2) || (secondSelection == 2 && firstSelection == 1) {
