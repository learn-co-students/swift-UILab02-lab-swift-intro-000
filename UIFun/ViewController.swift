...
class ViewController: UIViewController {
    ...
    @IBAction func colorSelected(_ sender: UISegmentedControl) {
        ...
        let choice = firstColorSegmentedControl.selectedSegmentIndex
        
        let choice2 = secondColorSegmentedControl.selectedSegmentIndex
        ...
        default:
            paintBucket.backgroundColor = UIColor.black
